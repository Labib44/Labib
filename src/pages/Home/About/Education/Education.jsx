    ...
    return (
        <div className="relative col-span-12 px-4 space-y-6 ">
            <div className="col-span-8 space-y-8 relative px-4 before:absolute before:top-2 before:bottom-0 before:w-0.5 before:-left-3 before:bg-gray-300">
                <div className="flex flex-col relative before:absolute before:top-6 before:w-4 before:h-4 before:rounded-full before:left-[-35px] before:z-[1] before:bg-[#77BD72]">
                    <h3 className="text-xl text-primary font-semibold tracki ml-5 mt-6">Basic Computer Application </h3>
                ...
                <div className="flex flex-col relative before:absolute before:top-0 before:w-4 before:h-4 before:rounded-full before:left-[-35px] before:z-[1] before:bg-[#77BD72]">
                    <h3 className="text-xl text-primary font-semibold tracki ml-5 ">Mastar Computer Application </h3>
