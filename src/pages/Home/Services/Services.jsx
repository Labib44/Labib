...
const Services = () => {
    ...
    return (
        <div id="service" className={`" pb-28 bg-[#F4F6FB] " ${!isDark ? "bg-[#343F4B]" : ""}`}>
            <div className="container mx-auto pt-32 lg:pt-32 md:pt-20 sm:pt-20 p-5 px-24 lg:px-0 md:px-0 sm:px-0">
                ...
                <h1 className={`" text-4xl lg:text-4xl md:text-3xl sm:text-3xl text-primary font-semibold text-center " ${!isDark ? "text-white" : ""}`}>Affordable Services</h1>
